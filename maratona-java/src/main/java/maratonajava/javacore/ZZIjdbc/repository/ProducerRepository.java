...
//                if (p.getName().equals("Toei")) throw new SQLException("Can't save Toei");
                ps.execute();
...
*/
    ...
    public static List<Producer> findByNameCallableStatement(String name) {
        log.info("Finding Producer findByNameCallableStatement");
    ...
    private static CallableStatement callableStatementFindByName(Connection conn, String name)
        ...
        String sql = "CALL `series_store`.`sp_get_producer_by_name`(?);";
